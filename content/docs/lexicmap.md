...
4.  Install LexicMap.
        ...
        wget https://github.com/shenwei356/LexicMap/releases/download/v0.9.0/lexicmap_linux_arm64.tar.gz
...
6.  (Optional) Prepare Taxonomy data to limit TaxId in
    ...
    v0.7.1.
        ...
        # taxonomic classification of AllTheBacteria v2.0 and incremental 202408 + 202505
